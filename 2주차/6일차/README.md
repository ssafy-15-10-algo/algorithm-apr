...
[문제링크](https://www.acmicpc.net/problem/22988)

---

## 문제 

![](https://upload.acmicpc.net/694d8a0d-fcd5-425a-86fd-e809f220ff7b/-/preview/)
...
$\min\left(A+B+\frac{X}{2},\ X\right)$㎖의 헤어에센스가 담긴 새로운 용기로 바꿔준다.

한별이의 화장품 가게 단골인 히나는 이제까지 사모은 헤어에센스 용기가 
$N$ 개 있다. 
$i$ 번째 용기에는 헤어에센스가 
$C_i$㎖ 담겨 있다. 히나는 한별이의 화장품 가게에 적당한 순서로 헤어에센스를 교환해서 용량이 꽉 찬, 즉, 
$X$㎖가 담겨 있는 헤어에센스 용기를 최대한 많이 만들고 싶다. 히나가 용량이 꽉 찬 헤어에센스를 최대 몇 개 만들 수 있는지 알려주자.
...
 
- $N$은 히나가 가진 헤어에센스 용기의 수이다. (
$1 \le N \le 100\,000$)
 
- $X$는 헤어에센스 용기의 총 용량이다. (
$1 \le X \le 10^{18}$)
 
- $C_i$는 
$i$ 번째 용기에 담겨 있는 헤어에센스의 용량이 
$C_i$㎖라는 의미이다. (
$0 \le C_i \le X$)
- 입력으로 주어지는 모든 수는 정수다.
...
첫 번째 용기와 두 번째 용기를 가져가서 용량이 
 
$\left(0+1+\frac{13}{2}\right)$㎖ 
$=$ 
$7.5$㎖ 남은 용기를, 세 번째 용기와 네 번째 용기를 가져가서 용량이 
 
$\left(2+3+\frac{13}{2}\right)$㎖ 
$=$ 
$11.5$㎖ 남은 용기를, 다섯 번째 용기와 여섯 번째 용기를 가져가서 용량이 
$13$㎖남은 헤어 에센스 용기를 받을 수 있다. 마지막으로 용량이 
$7.5$㎖ 남은 용기와 
$11.5$㎖ 남은 용기를 가져가서 용량이 
$13$㎖ 남은 헤어 에센스 용기를 하나 더 받을 수 있다.
